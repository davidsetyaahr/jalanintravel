...
(function($) {
    $.hunterTimePicker = function(box, options) {
        ...
        function buildHourTpl() {
            var hour_html = '<p>Pilih Waktu Dalam Format WIB</p>';
            ...
            hour_html += '<li class="Hunter-clean"><input type="button" class="Hunter-clean-btn" id="Hunter_clean_btn" value="Reset"></li>'
        ...
        function buildMinuteTpl(cur_time) {
            ...
            var minute_html = '<p>Menit Penjemputan</p>';
